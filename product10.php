...
<div class="ui-block-a">
    <div class="ui-block-a" id="event-collapse-time-pic" style="width:30%;padding:5%">
        <img src="images/products/product10.jpeg" class="divs_img" width="100%">
    </div>
    <div class="ui-block-b" style="width:70%; padding:5%;">
        <h1 style="font-family: Tahoma, sans-serif;font-size: 25px; color:#1128A4;"><b>Hair Shampo</b></h1>
        ...
        <h1 style="font-family: Tahoma, sans-serif;font-size: 35px; color: #40bf44;"><b>Rs.160</b></h1>
        <div>

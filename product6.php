...
<div class="ui-block-a">
    <div class="ui-block-a" id="event-collapse-time-pic" style="width:30%;padding:5%">
        <img src="images/products/product7.jpg" class="divs_img" width="100%">
    </div>
    <div class="ui-block-b" style="width:70%; padding:5%;">
        <h1 style="font-family: Tahoma, sans-serif;font-size: 25px; color:#1128A4;"><b>Skin Care Cream</b></h1>
        <p id="para1">Skin care is the range of practices that support skin integrity, enhance its appearance and relieve skin conditions.<br> 
        They can include nutrition, avoidance of excessive sun exposure <br>
        and appropriate use of emollients</p>
        <h1 style="font-family: Tahoma, sans-serif;font-size: 35px; color: #40bf44;"><b>Rs.560</b></h1>
        <div>

    ...
    for (var i = 0; i < products.length; i++) {
      for (j = 0; j < selectedProducts.length; j++) {
        ...
        if (products[i].id == selectedProducts[j]) {
          ...
          output += `<tr style="border-collapse:collapse"><td align="left" style="padding:0;Margin:0"><h4 style="Margin:0;line-height:120%;mso-line-height-rule:exactly;font-family:'lucida sans unicode', 'lucida grande', sans-serif;color:#1128A4"><b>` + products[i].price + `</b></h4></td></tr></table></td></tr></table><!--[if mso]></td></tr></table><![endif]--></td></tr>`;
        }
      }
    }
  }

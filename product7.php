...
<div class="ui-block-a">
    <div class="ui-block-a" id="event-collapse-time-pic" style="width:30%;padding:5%">
        <img src="images/products/chips.jpg" class="divs_img" width="100%">
    </div>
    <div class="ui-block-b" style="width:70%; padding:5%;">
        ...
        <p id="para1">Potato chips, or crisps, are thin slices of potato that have been either deep fried or baked until crunchy.<br> 
        They are commonly served as a snack, side dish, or appetizer</p>
        <h1 style="font-family: Tahoma, sans-serif;font-size: 35px; color: #40bf44;"><b>Rs.100</b></h1>
        <div>

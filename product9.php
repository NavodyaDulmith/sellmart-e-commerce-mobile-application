...
<div class="ui-block-a">
    <div class="ui-block-a" id="event-collapse-time-pic" style="width:30%;padding:5%">
        <img src="images/products/product9.png" class="divs_img" width="100%">
    </div>
    <div class="ui-block-b" style="width:70%; padding:5%;">
        <h1 style="font-family: Tahoma, sans-serif;font-size: 25px; color:#1128A4;"><b>Hair Conditioner</b></h1>
        <p id="para1">Hair conditioner is a hair care product used to improve the feel, appearance and manageability of hair.<br> 
        Its main purpose is to reduce friction between strands of hair to allow<br> 
        smoother brushing or combing, which might otherwise cause damage to the scalp</p>
        <h1 style="font-family: Tahoma, sans-serif;font-size: 35px; color: #40bf44;"><b>Rs.285</b></h1>
        <div>

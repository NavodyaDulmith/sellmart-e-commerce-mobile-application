		...
		<div data-role="main" class="ui-content main-content" align="center">
			<div class="ui-field-contain content">
				...
				<form method="POST" class="input-form" name="loginForm" onsubmit="return ValidateForm()">
					<div>
						<h2 style="text-align:center;margin-bottom:3px">SignUp </h2>
					</div>
					
					<input type="email" name="email" id="email" placeholder="First Name">
					<input type="password" name="password" id="password" placeholder="Last Name">
					<input type="password" name="password" id="password" placeholder="Mobile Number">
					...
					<button class="signup" style=" margin-bottom: 2px; border-radius: 100px;width:225px;background-color:#1128A4;color:white;border-radius: 100px;height:35px;text-align: center;" id="LogingBtn" onclick="submitBTN_validate()">SignUp</button>
					<div class="row" >
